...
function getSelector(operationVariables, fragment, item) {
  ...
  require('fbjs/lib/warning')(false, 'RelayModernSelector: Expected object to contain data for fragment `%s`, got ' + '`%s`. Make sure that the parent operation/fragment included fragment ' + '`...%s`.', fragment.name, JSON.stringify(item), fragment.name);
  return null;
}
