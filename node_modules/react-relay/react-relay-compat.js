...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("fbjs/lib/invariant"), require("react"), require("babel-runtime/helpers/classCallCheck"), require("babel-runtime/helpers/extends"), require("fbjs/lib/areEqual"), require("fbjs/lib/sprintf"), require("fbjs/lib/warning"), require("babel-runtime/helpers/inherits"), require("babel-runtime/helpers/possibleConstructorReturn"), require("prop-types"), require("relay-runtime"), require("fbjs/lib/emptyFunction"), require("fbjs/lib/forEachObject"), require("fbjs/lib/nullthrows"), require("fbjs/lib/removeFromArray"), require("babel-runtime/helpers/defineProperty"), require("fbjs/lib/mapObject"), require("fbjs/lib/base62"));
	else if(typeof define === 'function' && define.amd)
		define(["fbjs/lib/invariant", "react", "babel-runtime/helpers/classCallCheck", "babel-runtime/helpers/extends", "fbjs/lib/areEqual", "fbjs/lib/sprintf", "fbjs/lib/warning", "babel-runtime/helpers/inherits", "babel-runtime/helpers/possibleConstructorReturn", "prop-types", "relay-runtime", "fbjs/lib/emptyFunction", "fbjs/lib/forEachObject", "fbjs/lib/nullthrows", "fbjs/lib/removeFromArray", "babel-runtime/helpers/defineProperty", "fbjs/lib/mapObject", "fbjs/lib/base62"], factory);
	else if(typeof exports === 'object')
		exports["ReactRelayCompat"] = factory(require("fbjs/lib/invariant"), require("react"), require("babel-runtime/helpers/classCallCheck"), require("babel-runtime/helpers/extends"), require("fbjs/lib/areEqual"), require("fbjs/lib/sprintf"), require("fbjs/lib/warning"), require("babel-runtime/helpers/inherits"), require("babel-runtime/helpers/possibleConstructorReturn"), require("prop-types"), require("relay-runtime"), require("fbjs/lib/emptyFunction"), require("fbjs/lib/forEachObject"), require("fbjs/lib/nullthrows"), require("fbjs/lib/removeFromArray"), require("babel-runtime/helpers/defineProperty"), require("fbjs/lib/mapObject"), require("fbjs/lib/base62"));
	else
		root["ReactRelayCompat"] = factory(root["fbjs/lib/invariant"], root["react"], root["babel-runtime/helpers/classCallCheck"], root["babel-runtime/helpers/extends"], root["fbjs/lib/areEqual"], root["fbjs/lib/sprintf"], root["fbjs/lib/warning"], root["babel-runtime/helpers/inherits"], root["babel-runtime/helpers/possibleConstructorReturn"], root["prop-types"], root["relay-runtime"], root["fbjs/lib/emptyFunction"], root["fbjs/lib/forEachObject"], root["fbjs/lib/nullthrows"], root["fbjs/lib/removeFromArray"], root["babel-runtime/helpers/defineProperty"], root["fbjs/lib/mapObject"], root["fbjs/lib/base62"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_5__, __WEBPACK_EXTERNAL_MODULE_6__, __WEBPACK_EXTERNAL_MODULE_9__, __WEBPACK_EXTERNAL_MODULE_10__, __WEBPACK_EXTERNAL_MODULE_11__, __WEBPACK_EXTERNAL_MODULE_14__, __WEBPACK_EXTERNAL_MODULE_15__, __WEBPACK_EXTERNAL_MODULE_16__, __WEBPACK_EXTERNAL_MODULE_17__, __WEBPACK_EXTERNAL_MODULE_22__, __WEBPACK_EXTERNAL_MODULE_23__, __WEBPACK_EXTERNAL_MODULE_24__, __WEBPACK_EXTERNAL_MODULE_25__, __WEBPACK_EXTERNAL_MODULE_32__, __WEBPACK_EXTERNAL_MODULE_33__, __WEBPACK_EXTERNAL_MODULE_53__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  commitMutation: __webpack_require__(40).commitUpdate,
	...
	var QueryBuilder = {
	  ...
	  createQuery: function createQuery(partialQuery) {
	    ...
	    if (identifyingArgName != null) {
	      __webpack_require__(11)(partialQuery.identifyingArgValue != null, 'QueryBuilder.createQuery(): An argument value may be required for ' + 'query `%s(%s: ???)`.', partialQuery.fieldName, identifyingArgName);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RelayPropTypes = {
	  ...
	  Environment: function Environment(props, propName, componentName) {
	    ...
	    if (!__webpack_require__(20)(context) || !__webpack_require__(31)(context)) {
	  ...
	  ClassicRelay: function ClassicRelay(props, propName, componentName) {
	    ...
	    if (!__webpack_require__(8)(relay) || !__webpack_require__(20)(relay.environment)) {
	  ...
	  Relay: function Relay(props, propName, componentName) {
	    var relay = props[propName];
	    if (!__webpack_require__(8)(relay)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function isRelayContext(context) {
	  return typeof context === 'object' && context !== null && !Array.isArray(context) && __webpack_require__(31)(context.environment) && __webpack_require__(51)(context.variables);
	}
	  ...
	  RelayFragmentReference.prototype.getVariables = function getVariables(route, variables) {
	    ...
	    if (variableMapping) {
	      __webpack_require__(23)(variableMapping, function (value, name) {
	        ...
	        if (value === undefined) {
	          __webpack_require__(11)(false, 'RelayFragmentReference: Variable `%s` is undefined in fragment ' + '`%s`.', name, _this.getFragmentUnconditional().name);
	        } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createContainerWithFragments(Component, fragments) {
	  ...
	  var Container = function (_React$Component) {
	    ...
	    Container.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps, nextContext) {
	      ...
	      if (this.context.relay.environment !== relay.environment || this.context.relay.variables !== relay.variables || !__webpack_require__(9)(prevIDs, nextIDs)) {
	...
	function assertRelayContext(relay) {
	  __webpack_require__(1)(__webpack_require__(8)(relay), 'ReactRelayFragmentContainer: Expected `context.relay` to be an object ' + 'conforming to the `RelayContext` interface, got `%s`.', relay);
	  return relay;
	}
...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  var Container = function (_React$Component) {
	    ...
	    Container.prototype._getConnectionData = function _getConnectionData() {
	      ...
	      if (typeof hasMore !== 'boolean' || typeof cursor !== 'string') {
	        __webpack_require__(11)(false, 'ReactRelayPaginationContainer: Cannot paginate without %s fields in `%s`. ' + 'Be sure to fetch %s (got `%s`) and %s (got `%s`).', PAGE_INFO, componentName, direction === FORWARD ? HAS_NEXT_PAGE : HAS_PREV_PAGE, hasMore, direction === FORWARD ? END_CURSOR : START_CURSOR, cursor);
	        return null;
	      }
	      return {
	        cursor: cursor,
	...
	function assertRelayContext(relay) {
	  __webpack_require__(1)(__webpack_require__(8)(relay), 'ReactRelayPaginationContainer: Expected `context.relay` to be an object ' + 'conforming to the `RelayContext` interface, got `%s`.', relay);
	  return relay;
	}
	...
	function createContainer(Component, fragmentSpec, connectionConfig) {
	  return __webpack_require__(19)(Component, fragmentSpec, function (ComponentClass, fragments) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactRelayQueryRenderer = function (_React$Component) {
	  ...
	  ReactRelayQueryRenderer.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
	    if (nextProps.query !== this.props.query || nextProps.environment !== this.props.environment || !__webpack_require__(9)(nextProps.variables, this.props.variables)) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function assertRelayContext(relay) {
	  __webpack_require__(1)(__webpack_require__(8)(relay), 'ReactRelayRefetchContainer: Expected `context.relay` to be an object ' + 'conforming to the `RelayContext` interface, got `%s`.', relay);
	  return relay;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function commitRelayClassicMutation(environment, _ref) {
	  ...
	  if (typeof optimisticResponse === 'function') {
	    __webpack_require__(11)(false, 'RelayCompatMutations: Expected `optimisticResponse` to be an object, ' + 'received a function.');
	  ...
	  if (optimisticResponse && operation.node.kind === 'Mutation' && operation.node.calls && operation.node.calls.length === 1) {
	    ...
	    if (optimisticResponse[mutationRoot]) {
	      ...
	      __webpack_require__(11)(false, 'RelayCompatMutations: Expected `optimisticResponse`' + 'to contain the mutation name `%s` as a property, got `%s`', mutationRoot, optimisticResponse);
	    }
	  }
