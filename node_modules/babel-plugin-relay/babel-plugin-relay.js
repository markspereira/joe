	  ...
	  return {
	    visitor: {
	      TaggedTemplateExpression: function TaggedTemplateExpression(path, state) {
	        ...
	        var ast = __webpack_require__(23)(path);
	        if (ast) {
	          __webpack_require__(15)(t, path, state, ast);
	          return;
	        }

	        // Convert Relay.QL`` literals

	        var _getValidRelayQLTag = __webpack_require__(24)(path),
	        ...
	        if (quasi) {
	          ...
	          var documentName = __webpack_require__(21)(path, state);
	          path.replaceWith(__webpack_require__(11)(t, path, schema, quasi, documentName, propName, tagName, true, // enableValidation
	          state));
	        }
	      }
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _possibleConstructorReturn3 = _interopRequireDefault(__webpack_require__(26));

	var _inherits3 = _interopRequireDefault(__webpack_require__(25));
...
/***/ function(module, exports, __webpack_require__) {
	...
	function compileRelayQLTag(t, path, schemaProvider, quasi, documentName, propName, tagName, enableValidation, state) {
	  try {
	    var transformer = __webpack_require__(20)(schemaProvider, state.opts || {});
	    ...
	    throw path.buildCodeFrameError(__webpack_require__(19)(error), Error);
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RelayQLTransformer = function () {
	  ...
	  node, options) {
	    ...
	    var Printer = __webpack_require__(13)(t, this.options);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createAST(t, state, path, graphqlDefinition) {
	  ...
	  var modernNode = __webpack_require__(18)(t, graphqlDefinition, isHasteMode);
	  if (isCompatMode) {
	    return __webpack_require__(17)(t, modernNode, __webpack_require__(16)(t, path, graphqlDefinition, state));
	  }
	  return modernNode;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getClassicTransformer(schemaProvider, options) {
	  ...
	  if (!classicTransformer) {
	    ...
	    classicTransformer = new (__webpack_require__(14))(schema, {
	...
	function getSchema(schemaProvider) {
	  ...
	  var introspection = typeof schemaReference === 'string' ? __webpack_require__(22)(schemaReference) : schemaReference;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getSchemaIntrospection(schemaPath) {
	  try {
	    var source = __webpack_require__(28).readFileSync(schemaPath, 'utf8');
	    if (source[0] === '{') {
